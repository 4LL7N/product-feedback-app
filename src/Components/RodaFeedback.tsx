...
function RodaFeedback({ item,setDataInfo,dataInfo,setFilterInfo,filterInfo }: any) {
    ...
    >
      ...
      <div className="flex flex-col items-start justify-start px-6  gap-4">
        ...
        <div className="flex flex-row items-center justify-between  w-full md:w-8">
          <div className={`flex flex-row items-center  gap-2.5 py-1.5 pl-4 pr-[13px] ${upVote ? "bg-[#cfd7ff]" : "bg-[#f2f4fe] hover:bg-[#f2f4fe80] "} rounded-[10px] md:hidden`} onClick={() => {setUpVote(!upVote),UpVote()} } >
